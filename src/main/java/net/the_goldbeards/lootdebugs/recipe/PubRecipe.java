...
public class PubRecipe implements Recipe<SimpleContainer>
{
    ...
    public PubRecipe(ResourceLocation id, ItemStack output, long[] counts, boolean emerald) {
        this.id = id;
        this.output = output;
        this.counts = counts;
    ...
    public static class Type implements RecipeType<PubRecipe> {
        private Type() { }
        public static final Type INSTANCE = new Type();
        public static final String ID = "pub_brewing";
    }

    public static class Serializer implements RecipeSerializer<PubRecipe> {
        public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID = new ResourceLocation(LootDebugsMain.MOD_ID,"pub_brewing");


        @Override
        public PubRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new PubRecipe(id, output, countsJson, emerald);
        }

        @Override
        public PubRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf)
        {
            ...
            return new PubRecipe(id, output, counts, emerald);
        }

        @Override
        public void toNetwork(FriendlyByteBuf buf, PubRecipe recipe)
        {
