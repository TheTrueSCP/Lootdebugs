...
public class FuelItem extends Item
{
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        if(UsefullStuff.ItemNBTHelper.hasKey(pStack, "fuelAmount"))
        {
        pTooltipComponents.add(new TextComponent(new TranslatableComponent("tooltip.lootdebugs.fuel_canister.amount").getString() + UsefullStuff.ItemNBTHelper.getFloat(pStack, "fuelAmount") + "/" + (int)FuelItem.maxFuel));
        }
