...
public class OmmoranHearthstoneStructure extends StructureFeature<JigsawConfiguration> {

    public OmmoranHearthstoneStructure() {
        super(JigsawConfiguration.CODEC, OmmoranHearthstoneStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    private static boolean isFeatureChunk(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
     ...
     static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {

        // Check if the spot is valid for our structure. This is just as another method for cleanness.
        // Returning an empty optional tells the game to skip this spot as it will not generate the structure.
        if (!OmmoranHearthstoneStructure.isFeatureChunk(context)) {
        ...
        // Turns the chunk coordinates into actual coordinates we can use. (Gets center of that chunk)
         ...
         Optional<PieceGenerator<JigsawConfiguration>> structurePiecesGenerator =
                 JigsawPlacement.addPieces(
                         ...
                         height, // Position of the structure. Y value is ignored if last parameter is set to true.
