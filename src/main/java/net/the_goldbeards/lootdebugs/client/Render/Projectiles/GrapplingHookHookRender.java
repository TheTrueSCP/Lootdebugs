...
@OnlyIn(Dist.CLIENT)
public  class GrapplingHookHookRender extends EntityRenderer<GrapplingHookHookEntity> {
    protected static final ResourceLocation TEXTURE = new ResourceLocation(LootDebugsMain.MOD_ID, "textures/entity/projectiles/grappling_hook_hook.png");
    ...
    public GrapplingHookHookRender(EntityRendererProvider.Context context) {
        super(context);
        this.model = new GrapplingHookHookModel<>(context.bakeLayer(GrapplingHookHookModel.LAYER_LOCATION));
    }

    public void render(GrapplingHookHookEntity pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
    ...
    @Override
    public ResourceLocation getTextureLocation(GrapplingHookHookEntity pEntity) {
        return TEXTURE;
    }
