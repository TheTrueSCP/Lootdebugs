...
import net.the_goldbeards.lootdebugs.client.model.Projectiles.ShieldEmitterModel;

@OnlyIn(Dist.CLIENT)
public class ShieldRender extends EntityRenderer<ShieldEntity>
{
    protected final ResourceLocation TEXTURE = new ResourceLocation(LootDebugsMain.MOD_ID,"textures/entity/projectiles/shield_emitter.png");
    private final ShieldEmitterModel<ShieldEntity> model;

    public ShieldRender(EntityRendererProvider.Context context) {
        super(context);
        model = new ShieldEmitterModel<>(context.bakeLayer(ShieldEmitterModel.LAYER_LOCATION));
    }
