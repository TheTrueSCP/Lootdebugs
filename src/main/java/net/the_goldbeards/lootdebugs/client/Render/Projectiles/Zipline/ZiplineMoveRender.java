...
@OnlyIn(Dist.CLIENT)
public class ZiplineMoveRender extends EntityRenderer<ZiplineMoveEntity>
{
    ...
    public ZiplineMoveRender(EntityRendererProvider.Context context)
    {
        super(context);
    ...
    @Override
    public void render(ZiplineMoveEntity pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
    ...
    @Override
    public ResourceLocation getTextureLocation(ZiplineMoveEntity pEntity) {
