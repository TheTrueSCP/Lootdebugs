...
import net.the_goldbeards.lootdebugs.client.model.Projectiles.SatchelChargeModel;

public class SatchelChargeRender extends EntityRenderer<SatchelChargeEntity>
{
    protected final ResourceLocation TEXTURE = new ResourceLocation(LootDebugsMain.MOD_ID,"textures/entity/projectiles/satchel_charge/satchel_charge.png");
