...
public abstract class AbstractShootablePhysicsArrowLikeEntity extends Projectile
{
    ...
    public AbstractShootablePhysicsArrowLikeEntity(EntityType<? extends AbstractShootablePhysicsArrowLikeEntity> p_36721_, Level p_36722_) {
        super(p_36721_, p_36722_);

    }

    public AbstractShootablePhysicsArrowLikeEntity(EntityType<? extends AbstractShootablePhysicsArrowLikeEntity> p_36711_, double p_36712_, double p_36713_, double p_36714_, Level p_36715_) {
        this(p_36711_, p_36715_);
        this.setPos(p_36712_, p_36713_, p_36714_);
    }

    public AbstractShootablePhysicsArrowLikeEntity( EntityType<? extends AbstractShootablePhysicsArrowLikeEntity> entityType,LivingEntity p_36718_, Level p_36719_) {
        this(entityType, p_36718_.getX(), p_36718_.getEyeY() - (double)0.1F, p_36718_.getZ(), p_36719_);
